      ...
      <Form.Field name="name">
        ...
        <Form.Control asChild>
          <input
            type="text"
            required
            className="w-full bg-blackA2 shadow-gray-400 h-[35px] rounded-[4px] px-[10px] text-[15px] leading-none text-gray-800 shadow-[0_0_0_1px] outline-none hover:shadow-[0_0_0_1px_purple] focus:shadow-[0_0_0_2px_black]"
          />
        </Form.Control>
      </Form.Field>
      {type === "join-meet" && (
